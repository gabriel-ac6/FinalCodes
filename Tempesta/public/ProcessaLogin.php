...
$senha = $_POST['password_USUARIO'];
//Listar todos os dados do usuario de acordo com email e senha digitados no login
$sqlLogin = "SELECT * from usuario where email_USUARIO like '$email' and password_USUARIO like '$senha'";
...
if (mysqli_num_rows($rsLogin) > 0) {
    ...
    $statusLogin = 1;
    $_SESSION['permissao'] = $tblLogin['status_USUARIO'];
