<?php
include "Conecao.php";
$sqlLAV = "SELECT * FROM cme ORDER BY codigoANCME DESC LIMIT 10";
if (!isset($_GET['todos'])) {
  $rsLAV = mysqli_query($conn, $sqlLAV) or die(mysqli_error($conn));
} else {
  echo "2";
  $sqlAVA = "Select TOP 10 from cme desc ";
}
?>
                ...
                <div class="modal-body">
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <?php
                      $cont = 0;
                      while ($tblLAV = mysqli_fetch_array($rsLAV)) {
                      ?>

                        <div class="col-lg-2">
                          <center>
                            <font class="font1000"><?= $tblLAV['time21_5']; ?><br> </font>
                          </center>
                        </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ?>
                        ...
                        <div class="col-lg-12">
                          <center>
                            <font class="font1000"><?= $tblLAV['speed']; ?><br> </font>
                          </center>
                        </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ?>
                        ...
                        <div class="col-lg-12">
                          <center>
                            <font class="font1000"><?= $tblLAV['type']; ?><br> </font>
                          </center>
                        </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ?>
                        ...
                        <div class="col-lg-12">
                          <center>
                            <font class="font1000"><?= $tblLAV['halfAngle']; ?><br> </font>
                          </center>
                        </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ?>
                        ...
                        <div class="col-lg-12">
                          <center>
                            <font class="font1000"><?= $tblLAV['latitude']; ?><br> </font>
                          </center>
                        </div>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      ?>
                        ...
                        <div class="col-lg-12">
                          <center>
                            <font class="font1000"><?= $tblLAV['longitude']; ?><br> </font>
                          </center>
                        </div>
